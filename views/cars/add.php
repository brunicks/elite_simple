...
<div class="user-form-container">
    ...
    <div class="user-form-card">
        ...
        <div class="user-form-card-body">
            <form method="POST" action="<?= BASE_URL ?>car/create" enctype="multipart/form-data" id="addCarForm">
                ...
                <div class="user-form-row">
                    <div class="user-form-field">
                        ...
                        <input type="number" id="ano" name="ano" min="1900" max="<?= date('Y') + 1 ?>" required
                            class="user-form-input" value="<?= isset($_POST['ano']) ? $_POST['ano'] : '' ?>"
                            placeholder="<?= date('Y') ?>">
                    ...
                    <div class="user-form-field">
                        ...
                        <input type="text" id="preco" name="preco" required class="user-form-input" data-mask="currency"
                ...
                <div class="user-form-row">
                    <div class="user-form-field">
                        ...
                        <input type="number" id="km" name="km" min="0" required class="user-form-input"
                            value="<?= isset($_POST['km']) ? $_POST['km'] : '' ?>" placeholder="Ex: 45000">
                ...
                <div style="margin: 30px 0;">
                    <h3
                        style="color: #d4af37; font-size: 1.3rem; margin-bottom: 20px; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="user-form-row">
                        <div class="user-form-field">
                            ...
                            <input type="number" id="cv" name="cv" min="50" max="2000" class="user-form-input"
                                value="<?= isset($_POST['cv']) ? $_POST['cv'] : '' ?>" placeholder="Ex: 120">
