...
<main class="car-catalog-container">
    ...
    <!-- Ações do usuário -->
    <?php if ($is_logged_in): ?>
        <div class="catalog-user-actions">
            <a href="<?= ($_SESSION['user_type'] ?? '') === 'admin' ? BASE_URL . 'dashboard' : BASE_URL . 'dashboard/user' ?>" 
    ...
    <?php else: ?>
        <div class="catalog-guest-actions">
            ...
            <a href="<?= BASE_URL ?>auth" class="modern-btn modern-btn-primary">
                <i class="fas fa-user"></i> Fazer Login / Criar Conta
            </a>
        </div>
    <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (toggleButton && filtersContainer) {
        toggleButton.addEventListener('click', function() {
            const isExpanded = filtersContainer.classList.contains('show');
